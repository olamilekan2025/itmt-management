...
//         /*
//          * Keep the bell synchronized with the backend.
//          */
//         setUnreadCount(
//           Math.max(0, Number(response.unreadCount ?? 0))
//         );
...
//      Other lecturer pages can dispatch:
...
//       /*
//        * Recalculate from server instead of only
//        * decrementing local state.
//        */
...
//       /*
//        * If the request failed, get the real count
...
//     const nextValue = !notificationOpen;

//     setNotificationOpen(nextValue);
//     setProfileOpen(false);

//     if (nextValue) {
//       /*
//        * Always refresh from backend when bell opens.
//        */
//       loadUnreadCount();
...
//               type="button"
//               onClick={onMenuClick}
//               className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-600 shadow-sm transition hover:border-brand-navy/20 hover:bg-slate-50 hover:text-brand-navy lg:hidden"
...
//                 <h1 className="truncate text-lg font-bold tracking-tight text-brand-navy sm:text-xl">
//                   {title}
//                 </h1>
...
//                     : "border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:text-brand-navy",
//                 ].join(" ")}
//                 aria-label={
//                   unreadCount > 0
...
//               {notificationOpen && (
//                 <div className="absolute right-0 top-12 z-[60] w-[calc(100vw-2rem)] max-w-[380px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-900/10">
//                   {/* Header */}
...
//                           New announcements and academic
...
//                                 className={[
//                                   "group relative px-4 py-3.5 transition",
//                                   notification.isRead
...
//                         setNotificationOpen(false)
//                       }
//                       className="flex items-center justify-center gap-1.5 text-xs font-bold text-brand-navy transition hover:text-brand-gold"
//                     >
...
//               >
//                 <div className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-navy text-sm font-bold text-white shadow-sm ring-2 ring-brand-gold/20">
//                   {initials || "L"}
//                 </div>
...
//               {/* Profile dropdown */}
//               {profileOpen && (
//                 <div className="absolute right-0 top-12 z-[60] w-72 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-900/10">
...
//                         setProfileOpen(false)
//                       }
//                       className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 hover:text-brand-navy"
//                     >
...
//                     need to authenticate again to access your
//                     dashboard.
//                   </p>
//                 </div>
//               </div>
...
//                 }
//                 className="rounded-xl px-4 py-2.5 text-sm font-semibold text-slate-600 transition hover:bg-white hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-50"
//               >
//                 Cancel
//               </button>
